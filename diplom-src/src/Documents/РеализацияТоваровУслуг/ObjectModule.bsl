...
Процедура ВыполнитьАвтозаполнение(ДанныеФормы) Экспорт
	...
	Запрос = Новый Запрос;
	Запрос.Текст = "ВЫБРАТЬ
	               |	МАКСИМУМ(ЕСТЬNULL(ДоговорыАбоненскаяПлата.ВКМ_СуммаАбоненскойПлаты, 0)) КАК СуммаАбоненскойПлаты,
	               |	СУММА(ЕСТЬNULL(ВКМ_ВыполненныеКлиентуРаботыОбороты.СуммаКОплатеПриход, 0)) КАК СуммаРаботПоДоговору,
	               |	ДоговорыКонтрагентов.Ссылка КАК Договор
	               |ИЗ
	               |	Справочник.ДоговорыКонтрагентов КАК ДоговорыКонтрагентов
	               |		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ДоговорыКонтрагентов КАК ДоговорыАбоненскаяПлата
	               |		ПО ДоговорыКонтрагентов.Ссылка = ДоговорыАбоненскаяПлата.Ссылка
