...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	// {{ Алексеев М.Д.: Добавление новые профили групп доступа	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Специалист";
	ОписаниеПрофиля.Идентификатор = "148b9ab5-89dd-427f-89ee-bc7add38a3f5";
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеВариантовОтчетов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеДополнительныхОтчетовИОбработок");	
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавленияИзменениеДокументаОбслуживаниеКлиентов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеПросмотрОтчётаПоВыработкеСпециалистов");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "297130a3-4649-47b8-96ba-f8e15983f0ed";
	...
	ОписаниеПрофиля.Идентификатор = "258dc7ba-c726-4c3f-b655-d99a679be714";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Бухгалтер ИТФирмы'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеДокументовПродажи");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеПросмотрОбработкиМассовоеСозданиеАктов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеПросмотрОтчётаПоАнализуВыставленныхАктов");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля); 
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "КадровикРасчетчик";
	ОписаниеПрофиля.Идентификатор = "db6bec61-c8d5-4aad-90ca-fb4805817241";
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеДополнительныхСведений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавленияИзменениеДокументаНачисленияЗарплаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавленияИзменениеДокументаНачислениеФиксированныхПремий");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавленияИзменениеДокументаВыплатаЗарплаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавленияИзменениеДокументаГрафикОтпусков");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеПросмотрОтчётаПоВыработкеСпециалистов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеПросмотрОтчётаРасчётыССотрудниками");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеПросмотрОтчётаРасходЗапланированныхОтпусков");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
     //}}
